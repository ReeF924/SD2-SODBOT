...
var API = /** @class */ (function () {
    ...
    API.prototype.start = function () {
        ...
        this.express.get('/divElo', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var results;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.express.get('/', function (req, res) { res.send(200); });
        this.express.listen(this.port, function () {
            logs_1.Logs.log("HTTP server started on " + _this.port);
        });
    };
    return API;
}());
